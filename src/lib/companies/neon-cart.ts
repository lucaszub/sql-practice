...
ORDER BY total_revenue DESC;`,
      ...
      expectedRows: [
        { category: "Monitors", total_revenue: 1399.96 },
        { category: "Audio", total_revenue: 949.93 },
        { category: "Peripherals", total_revenue: 749.93 },
        { category: "Accessories", total_revenue: 502.82 },
        { category: "Storage", total_revenue: 419.96 },
...
ORDER BY category, total_revenue DESC;`,
      ...
      expectedRows: [
        ...
        { category: "Accessories", product_name: "HDMI Cable 2m", total_revenue: 129.90 },
        { category: "Accessories", product_name: "Mouse Pad XL", total_revenue: 89.94 },
        ...
        { category: "Monitors", total_revenue: 1199.97, product_name: "27\" 4K Monitor" },
        { category: "Monitors", total_revenue: 199.99, product_name: "24\" FHD Monitor" },
...
ORDER BY month;`,
      ...
      expectedRows: [
        ...
        { month: "2024-03-01", total_revenue: 969.94 },
        { month: "2024-04-01", total_revenue: 324.96 },
...
ORDER BY return_rate DESC;`,
      ...
      expectedRows: [
        { category: "Monitors", items_sold: 4, items_returned: 2, return_rate: 50.0 },
        { category: "Storage", items_sold: 5, items_returned: 1, return_rate: 20.0 },
        { category: "Peripherals", items_sold: 8, items_returned: 1, return_rate: 12.5 },
        { category: "Audio", items_sold: 8, items_returned: 1, return_rate: 12.5 },
        { category: "Accessories", items_sold: 19, items_returned: 2, return_rate: 10.5 },
        { category: "Gaming", items_sold: 2, items_returned: 0, return_rate: 0.0 },
      ],
      orderMatters: true,
    },
    {
      ...
      difficulty: "easy",
      description:
        "Nadia (Product Manager) wants to see the average rating and review count for each reviewed product. Only include products that have at least one rating (exclude NULL ratings). Show product name, review count, and average rating rounded to 1 decimal, sorted by average rating descending.",
      descriptionFr:
        "Nadia (Product Manager) veut voir la note moyenne et le nombre d'avis pour chaque produit ayant des avis. N'inclus que les produits avec au moins une note (exclure les NULL). Affiche le nom du produit, le nombre d'avis et la note moyenne arrondie à 1 décimale, trié par note décroissante.",
...
ORDER BY total_orders DESC;`,
      ...
      expectedRows: [
        { first_name: "Alice", last_name: "Martin", total_orders: 3 },
        { first_name: "Bob", last_name: "Dupont", total_orders: 2 },
...
ORDER BY order_date;`,
      ...
      expectedRows: [
        ...
        { order_date: "2024-05-03", daily_revenue: 49.99, cumulative_revenue: 3464.72 },
        { order_date: "2024-05-08", daily_revenue: 399.99, cumulative_revenue: 3864.71 },
        { order_date: "2024-05-20", daily_revenue: 44.99, cumulative_revenue: 3909.70 },
        { order_date: "2024-05-25", daily_revenue: 149.99, cumulative_revenue: 4059.69 },
      ],
      orderMatters: true,
    },
    {
...
ORDER BY total_revenue DESC;`,
      ...
      expectedRows: [
        { channel: "web", order_count: 17, total_revenue: 3287.72 },
        { channel: "mobile", order_count: 9, total_revenue: 669.89 },
      ],
      orderMatters: true,
    },
    {
