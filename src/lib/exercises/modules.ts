  ...
  modules: [
    ...
    // ── Intermediate ──────────────────────────────────────────
    {
      ...
      exerciseIds: [
        ...
        "122-campaign-region-gaps",
        "123-pro-feature-adoption-gaps",
        "124-shift-coverage-gaps",
        "125-store-category-promo-gaps",
        "126-monthly-account-gaps",
      ],
      skills: ["3+ table JOIN", "Self-join", "CROSS JOIN", "CROSS JOIN + INNER JOIN + LEFT JOIN"],
      icon: "\u{1F500}",
      prerequisites: ["B3"],
    },
    {
    ...
    },
    {
      ...
      exerciseIds: [
        "01-top-n-per-group",
        "102-row-number-basics",
        "103-rank-vs-dense-rank",
        "104-ntile-quartiles",
        "105-percent-rank-salary",
        "106-deduplication-latest-record",
        "107-top-performers-region",
        "108-rfm-segmentation",
      ],
      skills: ["ROW_NUMBER", "RANK", "DENSE_RANK", "NTILE", "PERCENT_RANK", "Top-N per group"],
      icon: "\u{1F3C6}",
      prerequisites: ["I1"],
    },
    {
      ...
      exerciseIds: [
        "03-yoy-growth",
        "109-lag-previous-month",
        "110-lead-next-event",
        "111-mom-growth",
        "112-first-last-value",
        "113-period-comparison",
        "114-trend-detection",
      ],
      skills: ["LAG", "LEAD", "FIRST_VALUE", "LAST_VALUE", "YoY growth", "MoM growth"],
      icon: "\u{1F4C8}",
      prerequisites: ["I3"],
    },
    {
    ...
    // ── Advanced ──────────────────────────────────────────────
    {
      ...
      exerciseIds: [
        ...
        "115-running-count",
        "116-rows-vs-range",
        "117-partitioned-running-total",
        "118-growth-target-tracking",
      ],
      skills: ["Running total", "Moving average", "Window frames", "ROWS vs RANGE"],
      icon: "\u{1F4C9}",
      prerequisites: ["I4"],
    },
    {
